...
if (CMAKE_BUILD_TYPE STREQUAL "Release")
	...
	execute_process(COMMAND
		...
		${PROJECT_NAME}View
		${PROJECT_VERSION}
		${CMAKE_INSTALL_PREFIX}/plugins/${CMAKE_BUILD_TYPE}/${Qt5Core_VERSION}/${CMAKE_CXX_COMPILER_ID}/${PLATFORM_TARGET}
	...
	if(qmlplugindump_result)
		message(WARNING "qmlplugindump exited with code ${qmlplugindump_result}")
	        ...
	        file(WRITE ${CMAKE_INSTALL_PREFIX}/plugins/${CMAKE_BUILD_TYPE}/${Qt5Core_VERSION}/${CMAKE_CXX_COMPILER_ID}/${PLATFORM_TARGET}/${PROJECT_NAME}View/${PROJECT_NAME}.qmltypes "${qmlplugindump_output}")
